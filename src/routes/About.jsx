...
const About = () => {
	...
	return (
		<AnimatedPage>
			...
			>
				<FormattedMessage
					id="about.headerSubText"
					defaultMessage="We are a team of data scientists and computer programmers with a vision
			...
			<ContentSection
				title={
					<FormattedMessage
						id="about.section1.title"
						defaultMessage="What's happening in Sri Lanka?"
					/>
				}
				img="protest.jpeg"
				bg="bg-light"
			>
				<FormattedMessage
					id="about.section1.content"
					defaultMessage="Sri Lanka is facing its worst economic crisis in more than 100 years.
			...
			>
				<FormattedMessage
					id="about.section2.content"
					defaultMessage="Sri Lankan citizens need access to important data that impacts their
			...
			<TeamContainer
				title={
					<FormattedMessage id="about.teams.title" defaultMessage="The Teams" />
				}
				subTitle="Code For Sri Lanka"
			>
				<TeamRow>
					<TeamItem
